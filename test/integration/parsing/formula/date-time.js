...
describe('.parse() date & time formulas', () => {
  ...
  it('DATE', () => {
    expect(parser.parse('DATE()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('DATEVALUE', () => {
    expect(parser.parse('DATEVALUE()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('DAY', () => {
    expect(parser.parse('DAY()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('DAYS', () => {
    expect(parser.parse('DAYS()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('DAYS(1)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('DAYS360', () => {
    expect(parser.parse('DAYS360()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('DAYS360(1)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('EDATE', () => {
    expect(parser.parse('EDATE()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('EDATE(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('EDATE("1/1/1900", 1)')).toMatchObject({error: null, result: new Date(1900, 1, 1)});
  });

  it('EOMONTH', () => {
    expect(parser.parse('EOMONTH()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('EOMONTH(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('EOMONTH("1/1/1900", 1)')).toMatchObject({error: null, result: new Date(1900, 1, 28)});
  });

  it('HOUR', () => {
    expect(parser.parse('HOUR()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ISOWEEKNUM', () => {
    expect(parser.parse('ISOWEEKNUM()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('MINUTE', () => {
    expect(parser.parse('MINUTE()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('MONTH', () => {
    expect(parser.parse('MONTH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('NETWORKDAYS', () => {
    expect(parser.parse('NETWORKDAYS()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('NETWORKDAYS("2/1/1901")')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SECOND', () => {
    expect(parser.parse('SECOND()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('SECOND("2/1/1901 13:33:12")')).toMatchObject({error: null, result: 12});
  });

  it('TIME', () => {
    expect(parser.parse('TIME()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('TIME(0)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('TIME(0, 0)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('TIMEVALUE', () => {
    expect(parser.parse('TIMEVALUE()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('WEEKDAY', () => {
    expect(parser.parse('WEEKDAY()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('WEEKNUM', () => {
    expect(parser.parse('WEEKNUM()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('WORKDAY', () => {
    expect(parser.parse('WORKDAY()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('WORKDAY("1/1/1900")')).toMatchObject({error: '#N/A', result: null});
  ...
  it('YEAR', () => {
    expect(parser.parse('YEAR()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('YEARFRAC', () => {
    expect(parser.parse('YEARFRAC()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('YEARFRAC("1/1/1904")')).toMatchObject({error: '#N/A', result: null});
