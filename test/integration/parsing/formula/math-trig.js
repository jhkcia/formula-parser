...
describe('.parse() math-trig formulas', () => {
  ...
  it('ABS', () => {
    expect(parser.parse('ABS()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ACOS', () => {
    expect(parser.parse('ACOS()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ACOSH', () => {
    expect(parser.parse('ACOSH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ACOT', () => {
    expect(parser.parse('ACOT()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ACOT(1)')).toBeMatchCloseTo({error: null, result: 0.7853981633974483});
    expect(parser.parse('ACOT(-1)')).toBeMatchCloseTo({error: null, result: -0.7853981633974483});
  });

  it('ACOTH', () => {
    expect(parser.parse('ACOTH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ARABIC', () => {
    expect(parser.parse('ARABIC()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ASIN', () => {
    expect(parser.parse('ASIN()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ASINH', () => {
    expect(parser.parse('ASINH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ATAN', () => {
    expect(parser.parse('ATAN()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ATAN2', () => {
    expect(parser.parse('ATAN2()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ATAN2(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ATAN2("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ATAN2(1, "value")')).toMatchObject({error: '#VALUE!', result: null});
    expect(parser.parse('ATAN2(1, 1)')).toBeMatchCloseTo({error: null, result: 0.7853981633974483});
  });

  it('ATANH', () => {
    expect(parser.parse('ATANH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('BASE', () => {
    expect(parser.parse('BASE()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('BASE("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('BASE(7)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('BASE(2, "value")')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('CEILING', () => {
    expect(parser.parse('CEILING()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('CEILING("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('CEILING(7.2)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('CEILING("value", 1)')).toMatchObject({error: '#VALUE!', result: null});
    expect(parser.parse('CEILING(7, 2, 8)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('CEILING(-4.3)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('CEILING(-1.234, 0.1)')).toMatchObject({error: null, result: -1.2});
    expect(parser.parse('CEILING(-1.234, 0.1, "value")')).toMatchObject({error: '#N/A', result: null});
  });

  it('COMBIN', () => {
    expect(parser.parse('COMBIN()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COMBIN("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COMBIN(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COMBIN(1, "A")')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('COMBINA', () => {
    expect(parser.parse('COMBINA()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COMBINA("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COMBINA(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COMBINA("a", 1)')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('COS', () => {
    expect(parser.parse('COS()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('COSH', () => {
    expect(parser.parse('COSH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('COT', () => {
    expect(parser.parse('COT()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COT("value")')).toMatchObject({error: '#VALUE!', result: null});
    expect(parser.parse('COT(0)')).toMatchObject({error: '#DIV/0!', result: null});
  ...
  it('COTH', () => {
    expect(parser.parse('COTH()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('COTH("value")')).toMatchObject({error: '#VALUE!', result: null});
    expect(parser.parse('COTH(0)')).toMatchObject({error: '#DIV/0!', result: null});
  ...
  it('CSC', () => {
    expect(parser.parse('CSC()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('CSC("value")')).toMatchObject({error: '#VALUE!', result: null});
    expect(parser.parse('CSC(0)')).toMatchObject({error: '#DIV/0!', result: null});
  ...
  it('CSCH', () => {
    expect(parser.parse('CSCH()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('CSCH("value")')).toMatchObject({error: '#VALUE!', result: null});
    expect(parser.parse('CSCH(0)')).toMatchObject({error: '#DIV/0!', result: null});
  ...
  it('DECIMAL', () => {
    expect(parser.parse('DECIMAL()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('DECIMAL("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('DECIMAL(1.3)')).toMatchObject({error: '#N/A', result: null});
    ...
    // expect(parser.parse('DECIMAL("32b", 16)')).toMatchObject({error: null, result: 811}); //TODO not support b anymore
  });

  it('DEGREES', () => {
    expect(parser.parse('DEGREES()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('EVEN', () => {
    expect(parser.parse('EVEN()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('EXP', () => {
    ...
    expect(parser.parse('EXP(1, 1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('EXP(1)')).toMatchObject({error: null, result: 2.718281828459045});
  });

  it('FACT', () => {
    expect(parser.parse('FACT()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('FACTDOUBLE', () => {
    expect(parser.parse('FACTDOUBLE()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('FLOOR', () => {
    expect(parser.parse('FLOOR()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('FLOOR("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('FLOOR(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('FLOOR(1, "value")')).toMatchObject({error: '#VALUE!', result: null});
    expect(parser.parse('FLOOR(3.33, 1.11)')).toMatchObject({error: null, result: 3});
    expect(parser.parse('FLOOR(6.998, -1.99)')).toMatchObject({error: '#NUM!', result: null});
    // expect(parser.parse('FLOOR(-1, -10)')).toMatchObject({error: null, result: 0});
    expect(parser.parse('FLOOR(10, 1)')).toMatchObject({error: null, result: 10});
  });

  it('GCD', () => {
    expect(parser.parse('GCD()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('INT', () => {
    expect(parser.parse('INT()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('LCM', () => {
    expect(parser.parse('LCM()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('LN', () => {
    expect(parser.parse('LN()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('LOG', () => {
    expect(parser.parse('LOG()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('LOG10', () => {
    expect(parser.parse('LOG10()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('MOD', () => {
    expect(parser.parse('MOD()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('MOD("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('MOD(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('MOD(1, "value")')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('MROUND', () => {
    expect(parser.parse('MROUND()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('MROUND("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('MROUND(1)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('MROUND(1, "value")')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('MULTINOMIAL', () => {
    expect(parser.parse('MULTINOMIAL()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ODD', () => {
    expect(parser.parse('ODD()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('POWER', () => {
    expect(parser.parse('POWER()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('POWER("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('POWER(2)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('POWER("value", 2)')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('PRODUCT', () => {
    expect(parser.parse('PRODUCT()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('QUOTIENT', () => {
    expect(parser.parse('QUOTIENT()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('QUOTIENT("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('QUOTIENT(2)')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('QUOTIENT(2, "value")')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('RADIANS', () => {
    expect(parser.parse('RADIANS()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ROMAN', () => {
    expect(parser.parse('ROMAN()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ROUND', () => {
    expect(parser.parse('ROUND()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ROUND("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ROUND(1)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ROUNDDOWN', () => {
    expect(parser.parse('ROUNDDOWN()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ROUNDDOWN("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ROUNDDOWN(1)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('ROUNDUP', () => {
    expect(parser.parse('ROUNDUP()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ROUNDUP("value")')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('ROUNDUP(1)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SEC', () => {
    expect(parser.parse('SEC()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SECH', () => {
    expect(parser.parse('SECH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SIGN', () => {
    expect(parser.parse('SIGN()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('SIGN(1, 2)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SIN', () => {
    expect(parser.parse('SIN()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('SIN(1, 2)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SINH', () => {
    expect(parser.parse('SINH()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('SINH(1, 2)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SQRT', () => {
    expect(parser.parse('SQRT()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('SQRT(1, 2)')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SQRTPI', () => {
    expect(parser.parse('SQRTPI()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('SUM', () => {
    expect(parser.parse('SUM()')).toMatchObject({error: '#N/A', result: null});
    expect(parser.parse('SUM("value")')).toMatchObject({error: '#VALUE!', result: null});
  ...
  it('SUMSQ', () => {
    expect(parser.parse('SUMSQ()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('TAN', () => {
    expect(parser.parse('TAN()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('TANH', () => {
    expect(parser.parse('TANH()')).toMatchObject({error: '#N/A', result: null});
  ...
  it('TRUNC', () => {
    expect(parser.parse('TRUNC()')).toMatchObject({error: '#N/A', result: null});
